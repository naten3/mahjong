...
export class NumberTile extends TileIdentifier {
  readonly type = TileIdentifierType.NUMBER_TILE
  numberValue: number;
...
export abstract class HonorTile extends TileIdentifier {
  readonly type = TileIdentifierType.HONORS_TILE;
...
export class BonusTile extends TileIdentifier{
  readonly type = TileIdentifierType.BONUS_TILE;
  numberValue: number;
